...
def collect_all(client: typing.Union[BinanceClient], exchange: str, symbol: str, from_time: int):
    ...
    while True:
        ...
        # Hard stop
        if int(oldest_ts - 60000) < from_time:
            logger.info(f"Stopped because {ms_to_dt(from_time)} has been reached")
            break
