    ...
    def evaluate_population(self, population: List[BacktestResult]) -> List[BacktestResult]:
        ...
        if self.strategy == "obv":
            for bt in population:
                bt.pnl, bt.max_dd, bt.num_trades = obv.backtest(self.data, ma_period=bt.parameters["ma_period"])
            ...
            for bt in population:
                bt.pnl, bt.max_dd, bt.num_trades = ichimoku.backtest(self.data, tenkan_period=bt.parameters["tenkan_period"],
            ...
            for bt in population:
                bt.pnl, bt.max_dd, bt.num_trades = support_resistance.backtest(self.data, min_points=bt.parameters["min_points"],
