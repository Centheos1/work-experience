...
public class MindBodyStaffConfig {
    ...
    @Value("${mindbody.service.staff.url}")
    private String MINDBODY_STAFF_WEB_SERVICE_URI;

    public String getMINDBODY_STAFF_WEB_SERVICE_URI() {
        return MINDBODY_STAFF_WEB_SERVICE_URI;
    }

    public void setMINDBODY_STAFF_WEB_SERVICE_URI(String MINDBODY_STAFF_WEB_SERVICE_URI) {
        this.MINDBODY_STAFF_WEB_SERVICE_URI = MINDBODY_STAFF_WEB_SERVICE_URI;
    }

    @Bean
    public Jaxb2Marshaller marshaller() {
        Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
        marshaller.setContextPath("com.fitnessplayground.model.mindbody.api.staff");
        return marshaller;
    }
    ...
    public MindBodyServiceGateway mindBodySale(Jaxb2Marshaller marshaller) {
        ...
        client.setDefaultUri(MINDBODY_STAFF_WEB_SERVICE_URI);
