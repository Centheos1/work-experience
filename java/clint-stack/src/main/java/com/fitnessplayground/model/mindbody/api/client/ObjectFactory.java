 ...
 * generated in the com.fitnessplayground.model.mindbody.api.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResourceID_QNAME = new QName("http://clients.mindbodyonline.com/api/0_5_1", "ID");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fitnessplayground.model.mindbody.api.client
     * 
     */
    ...
    public JAXBElement<Long> createClientServiceID(Long value) {
        return new JAXBElement<Long>(_ResourceID_QNAME, Long.class, ClientService.class, value);
    }
    ...
    public JAXBElement<Integer> createClientIndexID(Integer value) {
        return new JAXBElement<Integer>(_ResourceID_QNAME, Integer.class, ClientIndex.class, value);
    }
    ...
    public JAXBElement<Long> createContactLogID(Long value) {
        return new JAXBElement<Long>(_ResourceID_QNAME, Long.class, ContactLog.class, value);
    }
    ...
    public JAXBElement<Long> createAppointmentID(Long value) {
        return new JAXBElement<Long>(_ResourceID_QNAME, Long.class, Appointment.class, value);
    }
    ...
    public JAXBElement<Integer> createClientIndexValueID(Integer value) {
        return new JAXBElement<Integer>(_ResourceID_QNAME, Integer.class, ClientIndexValue.class, value);
    }
    ...
    public JAXBElement<Long> createStaffID(Long value) {
        return new JAXBElement<Long>(_ResourceID_QNAME, Long.class, Staff.class, value);
    }
