...
<wsdl:definitions xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://clients.mindbodyonline.com/api/0_5_1" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" targetNamespace="http://clients.mindbodyonline.com/api/0_5_1" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  ...
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://clients.mindbodyonline.com/api/0_5_1">
      ...
      <s:element name="GetContracts">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="Request" type="tns:GetContractsRequest" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="GetContractsRequest">
        <s:complexContent mixed="false">
          <s:extension base="tns:MBRequest">
            <s:sequence>
              <s:element minOccurs="0" maxOccurs="1" name="ContractIDs" type="tns:ArrayOfInt" />
              <s:element minOccurs="1" maxOccurs="1" name="SoldOnline" nillable="true" type="s:boolean" />
              <s:element minOccurs="1" maxOccurs="1" name="LocationID" type="s:int" />
            </s:sequence>
          </s:extension>
        </s:complexContent>
      ...
      <s:element name="GetContractsResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetContractsResult" type="tns:GetContractsResult" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="GetContractsResult">
        <s:complexContent mixed="false">
          <s:extension base="tns:MBResult">
            <s:sequence>
        ...
        <s:complexContent mixed="false">
          <s:extension base="tns:MBObject">
            <s:sequence>
              ...
              <s:element minOccurs="0" maxOccurs="1" name="Name" type="s:string" />
              <s:element minOccurs="0" maxOccurs="1" name="Description" type="s:string" />
              <s:element minOccurs="0" maxOccurs="1" name="AssignsMembershipId" nillable="true" type="s:int" />
              <s:element minOccurs="0" maxOccurs="1" name="AssignsMembershipName" type="s:string" />
              <s:element minOccurs="1" maxOccurs="1" name="SoldOnline" type="s:boolean" />
              <s:element minOccurs="0" maxOccurs="1" name="ContractItems" type="tns:ArrayOfContractItem" />
              <s:element minOccurs="0" maxOccurs="1" name="IntroOffer" type="s:string" />
              <s:element minOccurs="0" maxOccurs="1" name="AutopaySchedule" type="tns:AutopaySchedule" />
              <s:element minOccurs="1" maxOccurs="1" name="NumberOfAutopays" nillable="true" type="s:int" />
              <s:element minOccurs="0" maxOccurs="1" name="AutopayTriggerType" type="s:string" />
              <s:element minOccurs="0" maxOccurs="1" name="ActionUponCompletionOfAutopays" type="s:string" />
              <s:element minOccurs="0" maxOccurs="1" name="ClientsChargedOn" type="s:string" />
              <s:element minOccurs="1" maxOccurs="1" name="ClientsChargedOnSpecificDate" nillable="true" type="s:dateTime" />
              <s:element minOccurs="1" maxOccurs="1" name="DiscountAmount" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="DepositAmount" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="FirstAutopayFree" type="s:boolean" />
              <s:element minOccurs="1" maxOccurs="1" name="LastAutopayFree" type="s:boolean" />
              <s:element minOccurs="1" maxOccurs="1" name="ClientTerminateOnline" type="s:boolean" />
              <s:element minOccurs="0" maxOccurs="1" name="MembershipTypeRestrictions" type="tns:ArrayOfMembershipTypeRestriction" />
              <s:element minOccurs="0" maxOccurs="1" name="LocationPurchaseRestrictionIds" type="tns:ArrayOfInt" />
              <s:element minOccurs="0" maxOccurs="1" name="AgreementTerms" type="s:string" />
              <s:element minOccurs="1" maxOccurs="1" name="RequiresElectronicConfirmation" type="s:boolean" />
              <s:element minOccurs="1" maxOccurs="1" name="AutopayEnabled" type="s:boolean" />
              <s:element minOccurs="1" maxOccurs="1" name="FirstPaymentAmountSubtotal" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="FirstPaymentAmountTax" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="FirstPaymentAmountTotal" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="RecurringPaymentAmountSubtotal" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="RecurringPaymentAmountTax" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="RecurringPaymentAmountTotal" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="TotalContractAmountSubtotal" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="TotalContractAmountTax" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="TotalContractAmountTotal" type="s:decimal" />
            </s:sequence>
          </s:extension>
        </s:complexContent>
      </s:complexType>
      <s:complexType name="ArrayOfContractItem">
        <s:sequence>
          <s:element minOccurs="0" maxOccurs="unbounded" name="ContractItem" nillable="true" type="tns:ContractItem" />
        </s:sequence>
      </s:complexType>
      <s:complexType name="ContractItem">
        <s:sequence>
          <s:element minOccurs="0" maxOccurs="1" name="ID" type="s:string" />
          <s:element minOccurs="0" maxOccurs="1" name="Name" type="s:string" />
          <s:element minOccurs="0" maxOccurs="1" name="Description" type="s:string" />
          ...
          <s:element minOccurs="1" maxOccurs="1" name="OneTimeItem" type="s:boolean" />
        </s:sequence>
      </s:complexType>
      <s:complexType name="AutopaySchedule">
        <s:sequence>
          <s:element minOccurs="0" maxOccurs="1" name="FrequencyType" type="s:string" />
          <s:element minOccurs="1" maxOccurs="1" name="FrequencyValue" nillable="true" type="s:int" />
          <s:element minOccurs="0" maxOccurs="1" name="FrequencyTimeUnit" type="s:string" />
        </s:sequence>
      </s:complexType>
      <s:complexType name="ArrayOfMembershipTypeRestriction">
        <s:sequence>
          <s:element minOccurs="0" maxOccurs="unbounded" name="MembershipTypeRestriction" nillable="true" type="tns:MembershipTypeRestriction" />
        </s:sequence>
      </s:complexType>
      <s:complexType name="MembershipTypeRestriction">
        <s:complexContent mixed="false">
          <s:extension base="tns:MBObject">
            <s:sequence>
              <s:element minOccurs="1" maxOccurs="1" name="ID" type="s:int" />
      ...
      <s:element name="PurchaseContracts">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="Request" type="tns:PurchaseContractsRequest" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="PurchaseContractsRequest">
        <s:complexContent mixed="false">
          <s:extension base="tns:MBRequest">
            <s:sequence>
              <s:element minOccurs="1" maxOccurs="1" name="Test" nillable="true" type="s:boolean" />
              ...
              <s:element minOccurs="0" maxOccurs="1" name="FirstPaymentOccurs" type="s:string" />
              <s:element minOccurs="0" maxOccurs="1" name="ClientSignature" type="s:base64Binary" />
              <s:element minOccurs="0" maxOccurs="1" name="PromotionCode" type="s:string" />
      ...
      <s:element name="PurchaseContractsResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="PurchaseContractsResult" type="tns:PurchaseContractsResult" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="PurchaseContractsResult">
        <s:complexContent mixed="false">
          <s:extension base="tns:MBResult">
            <s:sequence>
              <s:element minOccurs="0" maxOccurs="1" name="ClientID" type="s:string" />
  ...
  <wsdl:message name="PurchaseContractsSoapIn">
    <wsdl:part name="parameters" element="tns:PurchaseContracts" />
  </wsdl:message>
  <wsdl:message name="PurchaseContractsSoapOut">
    <wsdl:part name="parameters" element="tns:PurchaseContractsResponse" />
  </wsdl:message>
  <wsdl:portType name="Sale_x0020_ServiceSoap">
    ...
    <wsdl:operation name="GetContracts">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Gets a list of contracts for a given location.</wsdl:documentation>
      <wsdl:input message="tns:GetContractsSoapIn" />
      <wsdl:output message="tns:GetContractsSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="PurchaseContracts">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Purchase a contract.</wsdl:documentation>
      <wsdl:input message="tns:PurchaseContractsSoapIn" />
      <wsdl:output message="tns:PurchaseContractsSoapOut" />
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:binding name="Sale_x0020_ServiceSoap" type="tns:Sale_x0020_ServiceSoap">
    <soap:binding transport="http://schemas.xmlsoap.org/soap/http" />
    <wsdl:operation name="GetAcceptedCardType">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetAcceptedCardType" style="document" />
      <wsdl:input>
    ...
    <wsdl:operation name="CheckoutShoppingCart">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/CheckoutShoppingCart" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetSales">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetSales" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetServices">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetServices" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="UpdateServices">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/UpdateServices" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetPackages">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetPackages" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetProducts">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetProducts" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="UpdateProducts">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/UpdateProducts" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="RedeemSpaFinderWellnessCard">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/RedeemSpaFinderWellnessCard" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetCustomPaymentMethods">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetCustomPaymentMethods" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="ReturnSale">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/ReturnSale" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="UpdateSaleDate">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/UpdateSaleDate" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetContracts">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetContracts" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="PurchaseContracts">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/PurchaseContracts" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:service name="Sale_x0020_Service">
    ...
    <wsdl:port name="Sale_x0020_ServiceSoap" binding="tns:Sale_x0020_ServiceSoap">
      <soap:address location="https://api.mindbodyonline.com/0_5_1/SaleService.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>