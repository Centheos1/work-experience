...
<wsdl:definitions xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://clients.mindbodyonline.com/api/0_5_1" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" targetNamespace="http://clients.mindbodyonline.com/api/0_5_1" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  ...
  <wsdl:binding name="Staff_x0020_ServiceSoap" type="tns:Staff_x0020_ServiceSoap">
    ...
    <wsdl:operation name="GetStaff">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetStaff" style="document" />
      <wsdl:input>
    ...
    <wsdl:operation name="GetStaffPermissions">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetStaffPermissions" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="AddOrUpdateStaff">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/AddOrUpdateStaff" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetStaffImgURL">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetStaffImgURL" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="ValidateStaffLogin">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/ValidateStaffLogin" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetSalesReps">
      <soap:operation soapAction="http://clients.mindbodyonline.com/api/0_5_1/GetSalesReps" style="document" />
      <wsdl:input>
        <soap:entityLookUp use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:service name="Staff_x0020_Service">
    ...
    <wsdl:port name="Staff_x0020_ServiceSoap" binding="tns:Staff_x0020_ServiceSoap">
      <soap:address location="https://api.mindbodyonline.com/0_5_1/StaffService.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>