export interface NoShowClient {
	...
	mbo_cancel_product_id: number;
	mbo_cancel_product_name: string;
	mbo_cancel_product_amount: number;
	...
	cancel_forgive_min: number; // -- A charge will not apply if the client has LESS THAN this many Cancels
	cancel_forgive_max: number; // -- A charge will not apply if the client has MORE THAN this many Cancels
	cancel_forgive_frequency: string; // -- Monthly or Weekly
	...
	dispute_auto_forgive: number; // -- the number of offences automatically forgiven
	is_test: boolean;
